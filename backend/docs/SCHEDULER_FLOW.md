...
| กลุ่มงานที่คิดเป็นวัน | **คำสำคัญ 8 คำ** | `PREPARE-OUTSOURCE` (จัดเตรียมส่งนอก), `OUTSOURCE` (ส่งนอก), `HEAT-TREATMENT` (อบชุบ), `HEAT_JUTAWAN` (อบชุบจุฑาวรรณ), `DEBURR-INSEPC` (ลบคม-ตรวจ), `BLACKENING_CCS` (รมดำ), `OQC` (ตรวจสอบขั้นสุดท้าย), `ROUGH_TURNING_CCS` (กลึงหยาบ) | 8, 10 | ❌ | `SCHED_DAY_UNIT_KEYWORDS` |
